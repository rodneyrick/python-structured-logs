...
def configure_logger(log_name, log_dir=None, log_level=logging.INFO, add_thread=False):
    ...
    if add_thread:
        shared_processors.append(add_thread_info)
        processors.append(add_thread_info)
